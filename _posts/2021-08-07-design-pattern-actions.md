...
1. 书本上的理论知识要多读几遍，有一些翻译看得不是很明白，不要太纠结，代码示例要弄懂，要动手照着写一写
2. 理论知识已学会，代码也写了，然后就是要悟，怎么悟呢？就是要思考每一种设计模式的应用场景，将其与自己过去的编码经历对应起来，看是否可以更好的解决问题。
3. 悟到其应用场景后，就是动手重构了，一旦重构成功，自己就会对这种设计模式有更深刻的理解了。
4. 设计模式一定是用来解决实际问题的，很多时候，我们按照既有的规则来写代码就可以了，强扭的瓜不会甜
